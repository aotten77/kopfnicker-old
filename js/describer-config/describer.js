...
// F
		...
		{
			jmname  : 'form-ajax-response',
			jmplugin: 'modules.form.formvalidate|actions.add_1|actions.add_2',
			jmconfig: [
				{
					'event': 'dominit',
					'ajax' : 'true'
				},
				{
					'event'    : 'dominit',
					'datatype' : 'attr',
					'data'     : '\'data-dcid:\' + window.jmGO.uuID.generate()',
					'relatedTo': 'this.$elem[0]'
				},
				{
					'event'    : '\'jmtrigger:done-\' + this.$elem.data(\'dcid\')',
					'datatype' : 'text',
					'relatedTo': 'this.$elem.parent()[0]'
				}
			]
...
// S
...

		{
			...
			jmconfig :{
				...
				'data':'\'checked:\'+this.$elem.prop(\'checked\').toString()'
			}
		},
